        ...
        <div className="px-6 py-3 mt-[22px]" id="channels">
            ...
            <ul className="list-none mt-[2.6em] px-[9px]">
               <li>
                <a href="/" id="google">
                    <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" className="w-[23px] h-6 inline text-[#C7D3D9] fill-current">
                        <path d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"/>
                    </svg>
                    </span>
                    <span className="inline-block fill-current text-[#A3B3CA] text-lg tracking-[0.02em] ml-6 translate-y-[2px]">
                        Google
                    </span>
                </a>
               </li>
               <li>
                <a href="/" id="facebook">
                    <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="w-[23px] h-6 inline text-[#C7D3D9] fill-current">
               ...
               <li>
                <a href="/" id="twitter">
                    <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-[23px] h-6 inline text-[#C7D3D9] fill-current">
               ...
               <li>
                <a href="/" id="linkedin">
                    <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-[23px] h-6 inline text-[#C7D3D9] fill-current">
               ...
               <li>
                <a href="/" id="pinterest">
                    <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="w-[23px] h-6 inline text-[#C7D3D9] fill-current">
               ...
               <li>
                <a href="/" id="slack">
                    <span>
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-[23px] h-6 inline text-[#C7D3D9]">
