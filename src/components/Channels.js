    ...
    return ( 
        <div className="px-6 py-3 mt-[22px]" id="channels">
            ...
            <ul className="list-none mt-[2.6em] px-[9px]">
               <li>
                <a href="#" id="google" onClick={ () => Click("google")}>
                    <span className="active" id="is-active-span">
                        <div className="absolute -left-[0.7rem] -top-2 w-11 h-11 bg-blue-500 rounded-full -z-10" id="is-active-bg"></div>
               ...
               <li>
                <a href="#" id="facebook" onClick={ () => Click("facebook")}>
                    <span className="active" id="is-active-span">
                        <div className="absolute -left-[0.7rem] -top-2 w-11 h-11 bg-blue-500 rounded-full -z-10" id="is-active-bg"></div>
               ...
               <li>
                <a href="#" id="twitter" onClick={ () => Click("twitter")}>
                    <span className="active" id="is-active-span">
                        <div className="absolute -left-[0.7rem] -top-2 w-11 h-11 bg-blue-500 rounded-full -z-10" id="is-active-bg"></div>
               ...
               <li>
                <a href="#" id="linkedin" onClick={ () => Click("linkedin")}>
                    <span id="is-active-span">
                    <div className="absolute -left-[0.7rem] -top-2 w-11 h-11 bg-blue-500 rounded-full -z-10 hidden" id="is-active-bg"></div>
               ...
               <li>
                <a href="#" id="pinterest" onClick={ () => Click("pinterest")}>
                    <span id="is-active-span">
                    <div className="absolute -left-[0.7rem] -top-2 w-11 h-11 bg-blue-500 rounded-full -z-10 hidden" id="is-active-bg"></div>
               ...
               <li>
                <a href="#" id="slack" onClick={ () => Click("slack")}>
                    <span id="is-active-span">
                    <div className="absolute -left-[0.7rem] -top-2 w-11 h-11 bg-blue-500 rounded-full -z-10 hidden" id="is-active-bg"></div>
