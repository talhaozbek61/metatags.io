const Channels = () => {
    ...
    const Click = id => {
       const clickDOM = document.querySelector(`#Preview #${id}`)
       const span     = document.querySelector(`#channels #${id} span`)
       const activeBg = document.querySelector(`#channels #${id} span #is-active-bg`)
       const channelName = document.querySelector(`#channels #${id} #channel-name`)

       if(clickDOM.className === "active") {
        clickDOM.classList.remove("active")
        clickDOM.classList.add("hidden")
        span.classList.remove("active")
        activeBg.classList.add("hidden")
        channelName.classList.remove("!text-black") 
       }
       else {
        clickDOM.classList.add("active")
        clickDOM.classList.remove("hidden")
        span.classList.add("active")
        activeBg.classList.remove("hidden")
        channelName.classList.add("!text-black")
       }
    }
    return ( 
        <div className="px-6 py-3 mt-[22px]" id="channels">
            ...
            <ul className="list-none mt-[2.6em] px-[9px]">
               <li>
                <button id="google" onClick={ () => Click("google")}>
                    <span className="active" id="is-active-span">
                        <div className="absolute -left-[0.7rem] -top-[0.3rem] w-11 h-11 bg-blue-500 rounded-full -z-10" id="is-active-bg"></div>
                    ...
                    <span className="inline-block fill-current text-lg tracking-[0.02em] ml-6 translate-y-[2px] !text-black" id="channel-name">
                        Google
                    </span>
                </button>
               </li>
               <li>
                <button id="facebook" onClick={ () => Click("facebook")}>
                    <span className="active" id="is-active-span">
                        <div className="absolute -left-[0.7rem] -top-[0.3rem] w-11 h-11 bg-blue-500 rounded-full -z-10" id="is-active-bg"></div>
               ...
               <li>
                <button id="twitter" onClick={ () => Click("twitter")}>
                    <span className="active" id="is-active-span">
                        <div className="absolute -left-[0.7rem] -top-[0.3rem] w-11 h-11 bg-blue-500 rounded-full -z-10" id="is-active-bg"></div>
               ...
               <li>
                <button id="linkedin" onClick={ () => Click("linkedin")}>
                    <span id="is-active-span">
                    <div className="absolute -left-[0.7rem] -top-[0.3rem] w-11 h-11 bg-blue-500 rounded-full -z-10 hidden" id="is-active-bg"></div>
                    ...
                    <span className="inline-block fill-current text-lg tracking-[0.02em] ml-6 translate-y-[2px]" id="channel-name">
                        Linkedin
                    </span>
                </button>
               </li>
               <li>
                <button id="pinterest" onClick={ () => Click("pinterest")}>
                    <span id="is-active-span">
                    <div className="absolute -left-[0.7rem] -top-[0.3rem] w-11 h-11 bg-blue-500 rounded-full -z-10 hidden" id="is-active-bg"></div>
               ...
               <li>
                <button id="slack" onClick={ () => Click("slack")}>
                    <span id="is-active-span">
                    <div className="absolute -left-[0.7rem] -top-[0.3rem] w-11 h-11 bg-blue-500 rounded-full -z-10 hidden" id="is-active-bg"></div>
